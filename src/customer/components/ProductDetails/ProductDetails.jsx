...
import { Box, ButtonBase, Grid, LinearProgress, Rating } from '@mui/material'
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opasity-50 text-sm'>56540 Ratings</p>
              ...
              <form className="mt-10">
                ...
                <ButtonBase onClick={handleAddToCart} variant="contained"   sx={{px:"2.5rem", py:".7rem", bgcolor:"#9155fd"}}>
                  Add To Cart
            </ButtonBase>
              ...
              <Grid container spacing={7}>
                ...
                <Grid item xs={5}>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="opacity-60">56876 Ratings</p>
                  </div>
                  <Box className="mt-5 spacy-y-3">
